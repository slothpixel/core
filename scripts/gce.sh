...
#redis
gcloud compute --project "snappy-nomad-263019" disks create "disk-redis" --size "50" --zone "us-central1-b" --type "pd-ssd"
...
#mongo
gcloud compute --project "snappy-nomad-263019" disks create "disk-mongo-1" --size "2000" --zone "us-central1-b" --type "pd-standard"
gcloud compute instances delete --quiet mongo-1
gcloud compute instances create mongo-1 --machine-type n1-highmem-2 --image-family ubuntu-1404-lts --image-project ubuntu-os-cloud --boot-disk-size 10GB --boot-disk-type pd-ssd --disk "name=disk-mongo-1,device-name=persistent-disk-1"
...
gcloud compute --project "snappy-nomad-263019" target-pools create "lb-pool" --region "us-central1" --health-check "lb-check" --session-affinity "NONE"
gcloud compute --project "snappy-nomad-263019" forwarding-rules create "lb-rule" --region "us-central1" --address "34.67.146.236" --ip-protocol "TCP" --port-range "80" --target-pool "lb-pool"
